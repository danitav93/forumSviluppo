...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000079b61530000000013712815(
...
class phpbbtemplatetwiglexer_00000000079b61530000000013712815 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b0d544a3a0bc135049930 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b0d544a3a0c5909868102 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b0d544a3a09f008345821 = array(
    ...
    {
        $this->initializer5b0d544a3a0c5909868102 && ($this->initializer5b0d544a3a0c5909868102->__invoke($valueHolder5b0d544a3a0bc135049930, $this, 'set_environment', array('env' => $env), $this->initializer5b0d544a3a0c5909868102) || 1) && $this->valueHolder5b0d544a3a0bc135049930 = $valueHolder5b0d544a3a0bc135049930;

        return $this->valueHolder5b0d544a3a0bc135049930->set_environment($env);
    }
    ...
    {
        $this->initializer5b0d544a3a0c5909868102 && ($this->initializer5b0d544a3a0c5909868102->__invoke($valueHolder5b0d544a3a0bc135049930, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b0d544a3a0c5909868102) || 1) && $this->valueHolder5b0d544a3a0bc135049930 = $valueHolder5b0d544a3a0bc135049930;

        return $this->valueHolder5b0d544a3a0bc135049930->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b0d544a3a0c5909868102 && ($this->initializer5b0d544a3a0c5909868102->__invoke($valueHolder5b0d544a3a0bc135049930, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b0d544a3a0c5909868102) || 1) && $this->valueHolder5b0d544a3a0bc135049930 = $valueHolder5b0d544a3a0bc135049930;

        return $this->valueHolder5b0d544a3a0bc135049930->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b0d544a3a0c5909868102 = $initializer;
    }
    ...
    {
        $this->initializer5b0d544a3a0c5909868102 && ($this->initializer5b0d544a3a0c5909868102->__invoke($valueHolder5b0d544a3a0bc135049930, $this, '__get', array('name' => $name), $this->initializer5b0d544a3a0c5909868102) || 1) && $this->valueHolder5b0d544a3a0bc135049930 = $valueHolder5b0d544a3a0bc135049930;

        if (isset(self::$publicProperties5b0d544a3a09f008345821[$name])) {
            return $this->valueHolder5b0d544a3a0bc135049930->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b0d544a3a0bc135049930;
    ...
    {
        $this->initializer5b0d544a3a0c5909868102 && ($this->initializer5b0d544a3a0c5909868102->__invoke($valueHolder5b0d544a3a0bc135049930, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b0d544a3a0c5909868102) || 1) && $this->valueHolder5b0d544a3a0bc135049930 = $valueHolder5b0d544a3a0bc135049930;
    ...
    {
        $this->initializer5b0d544a3a0c5909868102 && ($this->initializer5b0d544a3a0c5909868102->__invoke($valueHolder5b0d544a3a0bc135049930, $this, '__isset', array('name' => $name), $this->initializer5b0d544a3a0c5909868102) || 1) && $this->valueHolder5b0d544a3a0bc135049930 = $valueHolder5b0d544a3a0bc135049930;
    ...
    {
        $this->initializer5b0d544a3a0c5909868102 && ($this->initializer5b0d544a3a0c5909868102->__invoke($valueHolder5b0d544a3a0bc135049930, $this, '__unset', array('name' => $name), $this->initializer5b0d544a3a0c5909868102) || 1) && $this->valueHolder5b0d544a3a0bc135049930 = $valueHolder5b0d544a3a0bc135049930;
    ...
    {
        $this->initializer5b0d544a3a0c5909868102 && ($this->initializer5b0d544a3a0c5909868102->__invoke($valueHolder5b0d544a3a0bc135049930, $this, '__clone', array(), $this->initializer5b0d544a3a0c5909868102) || 1) && $this->valueHolder5b0d544a3a0bc135049930 = $valueHolder5b0d544a3a0bc135049930;

        $this->valueHolder5b0d544a3a0bc135049930 = clone $this->valueHolder5b0d544a3a0bc135049930;
    }

    public function __sleep()
    {
        $this->initializer5b0d544a3a0c5909868102 && ($this->initializer5b0d544a3a0c5909868102->__invoke($valueHolder5b0d544a3a0bc135049930, $this, '__sleep', array(), $this->initializer5b0d544a3a0c5909868102) || 1) && $this->valueHolder5b0d544a3a0bc135049930 = $valueHolder5b0d544a3a0bc135049930;

        return array('valueHolder5b0d544a3a0bc135049930');
    }
    ...
    {
        return $this->initializer5b0d544a3a0c5909868102;
    }
    ...
    {
        return $this->initializer5b0d544a3a0c5909868102 && ($this->initializer5b0d544a3a0c5909868102->__invoke($valueHolder5b0d544a3a0bc135049930, $this, 'initializeProxy', array(), $this->initializer5b0d544a3a0c5909868102) || 1) && $this->valueHolder5b0d544a3a0bc135049930 = $valueHolder5b0d544a3a0bc135049930;
    }
    ...
    {
        return null !== $this->valueHolder5b0d544a3a0bc135049930;
    }
    ...
    {
        return $this->valueHolder5b0d544a3a0bc135049930;
    }
