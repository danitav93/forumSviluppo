...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'mt.s3files.listener' => 'getMt_S3files_ListenerService',
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('mt.s3files.listener', 'MT\\s3files\\event\\main_listener');
    ...
    /**
     * Gets the public 'mt.s3files.listener' shared service.
     *
     * @return \MT\s3files\event\main_listener
     */
    protected function getMt_S3files_ListenerService()
    {
        return $this->services['mt.s3files.listener'] = new \MT\s3files\event\main_listener($this->get('config'), $this->get('template'), $this->get('user'), './../', $this->get('request'), $this->get('dbal.conn'), $this->get('auth'));
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000006c36c479000000003c95b8f6(
...
class phpbbtemplatetwiglexer_000000006c36c479000000003c95b8f6 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b2049655ce56766331221 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b2049655ce5e283094601 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b2049655ce39257906206 = array(
    ...
    {
        $this->initializer5b2049655ce5e283094601 && ($this->initializer5b2049655ce5e283094601->__invoke($valueHolder5b2049655ce56766331221, $this, 'set_environment', array('env' => $env), $this->initializer5b2049655ce5e283094601) || 1) && $this->valueHolder5b2049655ce56766331221 = $valueHolder5b2049655ce56766331221;

        return $this->valueHolder5b2049655ce56766331221->set_environment($env);
    }
    ...
    {
        $this->initializer5b2049655ce5e283094601 && ($this->initializer5b2049655ce5e283094601->__invoke($valueHolder5b2049655ce56766331221, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b2049655ce5e283094601) || 1) && $this->valueHolder5b2049655ce56766331221 = $valueHolder5b2049655ce56766331221;

        return $this->valueHolder5b2049655ce56766331221->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b2049655ce5e283094601 && ($this->initializer5b2049655ce5e283094601->__invoke($valueHolder5b2049655ce56766331221, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b2049655ce5e283094601) || 1) && $this->valueHolder5b2049655ce56766331221 = $valueHolder5b2049655ce56766331221;

        return $this->valueHolder5b2049655ce56766331221->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b2049655ce5e283094601 = $initializer;
    }
    ...
    {
        $this->initializer5b2049655ce5e283094601 && ($this->initializer5b2049655ce5e283094601->__invoke($valueHolder5b2049655ce56766331221, $this, '__get', array('name' => $name), $this->initializer5b2049655ce5e283094601) || 1) && $this->valueHolder5b2049655ce56766331221 = $valueHolder5b2049655ce56766331221;

        if (isset(self::$publicProperties5b2049655ce39257906206[$name])) {
            return $this->valueHolder5b2049655ce56766331221->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b2049655ce56766331221;
    ...
    {
        $this->initializer5b2049655ce5e283094601 && ($this->initializer5b2049655ce5e283094601->__invoke($valueHolder5b2049655ce56766331221, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b2049655ce5e283094601) || 1) && $this->valueHolder5b2049655ce56766331221 = $valueHolder5b2049655ce56766331221;
    ...
    {
        $this->initializer5b2049655ce5e283094601 && ($this->initializer5b2049655ce5e283094601->__invoke($valueHolder5b2049655ce56766331221, $this, '__isset', array('name' => $name), $this->initializer5b2049655ce5e283094601) || 1) && $this->valueHolder5b2049655ce56766331221 = $valueHolder5b2049655ce56766331221;
    ...
    {
        $this->initializer5b2049655ce5e283094601 && ($this->initializer5b2049655ce5e283094601->__invoke($valueHolder5b2049655ce56766331221, $this, '__unset', array('name' => $name), $this->initializer5b2049655ce5e283094601) || 1) && $this->valueHolder5b2049655ce56766331221 = $valueHolder5b2049655ce56766331221;
    ...
    {
        $this->initializer5b2049655ce5e283094601 && ($this->initializer5b2049655ce5e283094601->__invoke($valueHolder5b2049655ce56766331221, $this, '__clone', array(), $this->initializer5b2049655ce5e283094601) || 1) && $this->valueHolder5b2049655ce56766331221 = $valueHolder5b2049655ce56766331221;

        $this->valueHolder5b2049655ce56766331221 = clone $this->valueHolder5b2049655ce56766331221;
    }

    public function __sleep()
    {
        $this->initializer5b2049655ce5e283094601 && ($this->initializer5b2049655ce5e283094601->__invoke($valueHolder5b2049655ce56766331221, $this, '__sleep', array(), $this->initializer5b2049655ce5e283094601) || 1) && $this->valueHolder5b2049655ce56766331221 = $valueHolder5b2049655ce56766331221;

        return array('valueHolder5b2049655ce56766331221');
    }
    ...
    {
        return $this->initializer5b2049655ce5e283094601;
    }
    ...
    {
        return $this->initializer5b2049655ce5e283094601 && ($this->initializer5b2049655ce5e283094601->__invoke($valueHolder5b2049655ce56766331221, $this, 'initializeProxy', array(), $this->initializer5b2049655ce5e283094601) || 1) && $this->valueHolder5b2049655ce56766331221 = $valueHolder5b2049655ce56766331221;
    }
    ...
    {
        return null !== $this->valueHolder5b2049655ce56766331221;
    }
    ...
    {
        return $this->valueHolder5b2049655ce56766331221;
    }
