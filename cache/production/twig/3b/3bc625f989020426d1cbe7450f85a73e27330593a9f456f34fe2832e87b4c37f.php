...
/* posting_editor.html */
class __TwigTemplate_2cbc0e7af83ab054a91a3cd8f4bfd6530f027a5f44c3d1efa91bd8ae2dd331ba extends Twig_Template
{
...
\t\t\t\t";
                ...
                echo "\t\t\t\t";
                $previous_look_up_order = $this->env->getNamespaceLookUpOrder();
                $this->env->setNamespaceLookUpOrder(array('MT_s3files', '__main__'));
                $this->env->loadTemplate('@MT_s3files/event/posting_editor_add_panel_tab.html')->display($context);
                $this->env->setNamespaceLookUpOrder($previous_look_up_order);
                // line 125
                echo "\t\t\t</ul>
\t\t</div>
